...
## Project Structure
    ...
    ├── ideapros_llc_tesoro_33287  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_tesoro_33287`
...
2. Clone this repo and `cd ideapros_llc_tesoro_33287`
